...
def categorisation (argu):
    ...
    categories = "Paysages ; Fleurs ; Animaux ; Voitures ; Bateaux ; Personnes ; Bâtiments ; Illustration ; Divers ; Nourriture ; Art abstrait ; Événements spéciaux ; Sport et loisirs ; Mode ; Musique ; Voyages, Signature"
